      ...
      <div>
        <div className='row align-center space-between'>
          ...
          <div className='show-sides align-center'>
            ...
            <a href='#experience' className='options grey-text'> <span className='green-text'>02.</span> Experience</a>
            <a href='#projects' className='options grey-text'> <span className='green-text'>03.</span> Projects</a>
            <a href='#contact-me' className='options grey-text'> <span className='green-text'>04.</span> Contact</a>
            <ResumeButton />
          </div>
